...
public class Part1
{
    ...
    public void Test1()
    {
        ...
        var sum = CalculateSumOfParts(input);
    ...
    public void Test5()
    {
        ...
        Assert.Equal(527144, sum);
    }

    private static int CalculateSumOfParts(string input) => FindParts(input).Sum();

    private static IEnumerable<int> FindParts(string input)
    {
        ...
        for (var y = 0; y < lines.Length; y++)
        {
            ...
            for (var x = 0; x < line.Length; x++)
            {
                ...
                if (char.IsSymbol(character) || char.IsPunctuation(character) && character != '.') symbols.Add(new Coordinate(x, y));
        ...
        foreach (var number in numbers)
        {
            ...
            {
                if (number.Key.IsAdjacent(symbol))
                {

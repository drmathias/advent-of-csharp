...
public class Part2
{
    ...
    public void Test1()
    {
        ...
        var sum = CalculatePowerSum(input);
    ...
    public void Test5()
    {
        ...
        Assert.Equal(54911, sum);
    }

    public static int CalculatePowerSum(string input)
        => input.Split(Environment.NewLine).Sum(line => CalculatePower(line.Split(':')[1]));
